...
//    [[REiosHandler getNotification] setForegroundNotificationWithNotification:notification completionHandler:UNNotificationPresentationOptionNone];
    
    
    [[REiosHandler getNotification]setForegroundNotificationWithNotification:notification completionHandler:^(UNNotificationPresentationOptions options ) {
